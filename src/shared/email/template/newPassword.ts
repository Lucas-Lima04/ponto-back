const newPasswordTemplate = (name: string, newPassword:string, hospital: string, medicalGroup: string) => {
    return `
    <!doctype html>
<html>
  <head>
              ...
              <tr>
                <td class="wrapper" style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 0px;" valign="top">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; width: 100%;background: #ffffff; border-radius: 16px; " width="100%">
                    ...
                    <br>
                    <br>
                      <h2 style="font-family: sans-serif; font-weight: 400; line-height: 1.4; margin: 0; margin-bottom: 30px; color: #ffffff;">${hospital}</h2>
                      </td></tr>
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                          ...
                          <h1 style="font-family: sans-serif; line-height: 1.4; margin: 0; margin-bottom: 30px; font-weight: 300; text-transform: capitalize; text-align: left; margin-left: 2rem; color: #009FFA; font-size: 1.8rem;">Olá ${name}.</h1>
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px; color: #49575E; padding: 0 2rem;">
                            <br>                            
                            ${medicalGroup.length > 0 ?  `Você foi adicionado ao grupo ${medicalGroup}}` : `Você foi adicionado ao hospital`}
                            <br>
                            <br>
                            <br>
                            <br>
